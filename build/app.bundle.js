...
/* harmony import */ var _tensorflow__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./tensorflow */ "./js/tensorflow.js");
/* harmony import */ var _tensorflow__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_tensorflow__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _artyom__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./artyom */ "./js/artyom.js");
/* harmony import */ var _artyom__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_artyom__WEBPACK_IMPORTED_MODULE_2__);
...
var buttonTrigger = document.getElementById("sayword");
var startBtn = document.getElementById("start");
var stopBtn = document.getElementById("stop");
var speechLog = document.getElementById("speech-log__inner");
var textSaid; // artyom.initialize({
// 	continuous:true,
// 	lang:"nl-NL",
...
var speechStuff = {
  init: function init() {
    document.addEventListener('DOMContentLoaded', function () {
      buttonTrigger.addEventListener("click", function () {// this.sayWord('data eyecatcher kan nederlands praten');
      });
...
var tensorflow = {
  ...
  webcam: function webcam() {
    ...
    if (navigator.mediaDevices && navigator.mediaDevices.getUserMedia) {
      ...
      Promise.all([modelPromise, webCamPromise]).then(function (values) {
        _this2.detectFrame(videoRef, values[0]);
  ...
  detectFrame: function detectFrame(video, model) {
    var _this3 = this;
  ...
  renderPredictions: function renderPredictions(predictions) {
    biggestFish = null;
    ...
    for (var i = 0; i < predictions.length; i++) {
      ...
      var width = predictions[i].bbox[2];
